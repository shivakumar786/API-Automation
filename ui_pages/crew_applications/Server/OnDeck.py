...
class OnDeck(General):
    ...
    def __init__(self, web_driver):
        ...
        self.locators = self.dict_to_ns({
            ...
            "bump_order": "//*[@class='android.widget.Button']//*[@text='BUMP']",
            ...
            "apply":"//*[@class='android.widget.Button'][@text='APPLY']"
        })
    ...
    def bump_order(self):
        """
        bump order on ondeck tab
        :return:
        """
        self.webDriver.click(element=self.locators.order_tabs, locator_type='xpath')
        self.webDriver.wait_for(2)
        self.webDriver.click(element=self.locators.OnDeck, locator_type='xpath')
        if self.webDriver.is_element_display_on_screen(element=self.locators.bump_order, locator_type='xpath'):
            self.webDriver.click(element=self.locators.bump_order, locator_type='xpath')
        else:
            raise Exception("Something went wrong")

    def filter_ondeck(self):
        """
        filter order
        :return:
        """
        ...
        self.webDriver.wait_for(2)
        self.webDriver.click(element=self.locators.checkbox, locator_type='xpath')
        self.webDriver.wait_for(2)
        if self.webDriver.is_element_display_on_screen(element=self.apply, locator_type='xpath'):
