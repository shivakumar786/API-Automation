...
class Cart(General):
    ...
    def __init__(self, web_driver):
        ...
        self.locators = self.dict_to_ns({
            ...
            "deliver_order":"//*[@class='android.widget.Button']//*[@text='DELIVER']"
        })
    ...
    def deliver_order(self):
        ...
        self.webDriver.click(element=self.locators.cart, locator_type='xpath')
        if self.webDriver.is_element_display_on_screen(element=self.locators.deliver_order, locator_type='xpath'):
            self.webDriver.click(element=self.locators.deliver_order, locator_type='xpath')
        else:
