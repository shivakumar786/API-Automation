...
class DistributionList(General):
    ...
    def __init__(self, web_driver):
        ...
        self.locators = self.dict_to_ns({
            ...
            "delete_dist_list": "//*[text()='DELETE']",
            "delete_dist": "(//*[text()='DELETE'])[2]",
            "public_tab": "//*[text()='Public']",
            "Private_tab": "//*[text()='Private']",
            "search_not_found_message": "//*[contains(text(),'Oops!')]",
    ...
    def create_new_distribution_list(self, test_data):
        ...
        if self.webDriver.is_element_display_on_screen(element=self.locators.distribution_list_box, locator_type='xpath'):
            if self.webDriver.get_text(element=self.locators.distribution_list_box, locator_type='xpath') == "Create New Distribution List":
                ...
                self.webDriver.set_text(element=self.locators.list_name, locator_type='id',
    ...
    def delete_dist_list_and_verify(self):
        """
        To verify user is able to delete distribution list
        :return:
        """
        self.webDriver.click(element=self.locators.delete_dist_list, locator_type="xpath")
        self.webDriver.click(element=self.locators.delete_dist, locator_type="xpath")
        self.wait_for_loader_to_complete()
        ...
        self.wait_for_loader_to_complete()
        search_response = self.webDriver.get_text(element=self.locators.search_not_found_message, locator_type="xpath")
        assert search_response == "Oops! We couldn't find the thing you are looking for. Try with something else.", \
            "failed to delete created distribution list "
    ...
    def verify_boarding_slots(self, recipient_category):
        ...
        self.webDriver.click(element=self.locators.create_distribution_button, locator_type='xpath')
        self.wait_for_loader_to_complete()
        if self.webDriver.is_element_display_on_screen(element=self.locators.distribution_list_box,
                                                       locator_type='xpath'):
            if self.webDriver.get_text(element=self.locators.distribution_list_box,
                                       locator_type='xpath') == "Create New Distribution List":
                self.webDriver.set_text(element=self.locators.recipients, locator_type='xpath', text='sailor')
