...
class Notification(General):
    ...
    def __init__(self, web_driver, test_data):
        ...
        self.locators = self.dict_to_ns({
            ...
            "notification_title": "freeform-notification-title",
            "text_area": "//div//textarea[@id='filled-basic-template']",
            "url": "filled-basic-externalUrl",
            ...
            "draft_search_bar": "//input[@placeholder='Search by keyword']",
            "notification_list": "//mark[text()='%s']",
            ...
            "schedule_radio_btn": "//span[text()='Schedule for selected Voyage']",
            "date": "demo-select-filled-days",
            "days": "notification-date-label",
            ...
            "recurring_radio_btn": "//span[text()='Recurring Schedule for selected Voyage']",
            "daily": "//span[text()='Daily']",
            "weekly": "//span[text()='Weekly']",
            "boarding_time": "demo-simple-select-filled-boarding-time",
            "boarding_slots": "//li[@data-value='[object Object]']",
            "unassigned_cabins": "//span[text()='Booking with unassigned cabins']",
            "unassigned_toggle": "//input[@class='jss452 MuiSwitch-input']",
    ...
    def schedule_for_selected_voyage(self):
        """
        To schedule for selected voyage
        :return:
        """
        ...
        self.webDriver.click(element=self.locators.days, locator_type='id')
    ...
    def enter_url(self, config):
        ...
        :param config:
        """
        url = urljoin(config.shore.url.replace('/svc', ''), "/notificationManagement/login")
        self.webDriver.set_text(element=self.locators.url, locator_type='id', text=url)
        self.wait_for_loader_to_complete()

    def create_template_notification_schedule_selected_voyage(self, recipient_category, cabin):
        """
        To create new template notification with scheduled for selected voyage
        :param cabin:
        ...
        if (recipient_category == 'sailor' or recipient_category == 'crew') and cabin is None:
            ...
            time.sleep(5)
            self.webDriver.explicit_visibility_of_element(element=self.locators.save, locator_type='xpath',
                                                          time_out=120)
            self.webDriver.click(element=self.locators.save, locator_type='xpath')
            self.webDriver.explicit_visibility_of_element(element=self.locators.send_button % 1, locator_type='xpath',
                                                          time_out=120)
    ...
    def schedule_recurring(self, test_data):
        """
        To schedule for Recurring(Weekly/Daily)
        :return:
        """
        self.webDriver.click(element=self.locators.recurring_radio_btn, locator_type='xpath')
        self.webDriver.scroll_complete_page()
        self.wait_for_loader_to_complete()
        test_data['recurring'] = random.choice(['Daily', 'Weekly'])
        if test_data['recurring'] == 'Daily':
            self.webDriver.click(element=self.locators.daily, locator_type='xpath')
        else:
            self.webDriver.click(element=self.locators.weekly, locator_type='xpath')
    ...
    def create_new_free_form_notification(self, config, test_data, recipient_category, scheduling):
        ...
        url = urljoin(config.shore.url.replace('/svc', ''), "/notificationManagement/login")
        self.webDriver.set_text(element=self.locators.notification_title, locator_type='id',
        ...
        self.webDriver.set_text(element=self.locators.url, locator_type='id', text=url)
        if scheduling == 'selected_voyage':
            self.schedule_for_selected_voyage()
        if scheduling == 'recurring':
            self.schedule_recurring(test_data)
        self.webDriver.click(element=self.locators.add_recipient_button, locator_type='xpath')
        self.wait_for_loader_to_complete()
        self.webDriver.set_text(element=self.locators.recipients, locator_type='xpath', text=recipient_category)
        self.webDriver.get_web_element(element=self.locators.recipients, locator_type='xpath').send_keys(
    ...
    def click_save_button(self, scheduling):
        ...
        :return:
        """
        if scheduling == 'selected_voyage' or scheduling == 'recurring':
            self.webDriver.explicit_visibility_of_element(element=self.locators.save, locator_type='xpath',
                                                          time_out=120)
            self.webDriver.click(element=self.locators.save, locator_type='xpath')
            self.wait_for_loader_to_complete()
            ...
            self.webDriver.click(element=self.locators.send_button % 1, locator_type='xpath')
            self.wait_for_loader_to_complete()
            self.webDriver.explicit_visibility_of_element(element=self.locators.send_button % 2, locator_type='xpath',
                                                          time_out=120)
            self.webDriver.click(element=self.locators.send_button % 2, locator_type='xpath')
            self.wait_for_loader_to_complete()
    ...
    def verify_created_notification(self, title):
        ...
        for retry in range(0, 10):
            ...
            self.wait_for_loader_to_complete()
            self.webDriver.explicit_visibility_of_element(element=self.locators.notification_list % title,
                                                          locator_type='xpath', time_out=60)
            notification_list = self.webDriver.get_elements(element=self.locators.notification_list % title,
                                                            locator_type='xpath')
    ...
    def verify_message(self, test_data):
        ...
        self.webDriver.get_web_element(element=self.locators.search_bar, locator_type='xpath').send_keys(Keys.ENTER)
        notification_list = self.webDriver.get_elements(element=self.locators.notification_list % test_data['message'],
                                                        locator_type='xpath')
    ...
    def update_and_save(self):
        ...
        self.webDriver.explicit_visibility_of_element(element=self.locators.update_button, locator_type="xpath",
                                                      time_out=120)
        self.webDriver.wait_for(5)
    ...
    def select_and_save_recipients(self, recipient_category):
        """
        To select and save recipients from Add Recipients
        :param recipient_category:
        :return:
        """
        self.webDriver.click(element=self.locators.add_recipient_button, locator_type='xpath')
    ...
    def verify_boarding_slots(self, recipient_category):
        """
        To verify boarding slots are available
        :return:
        """
        self.webDriver.scroll_till_element(element=self.locators.add_recipient_button, locator_type='xpath')
        self.webDriver.click(element=self.locators.add_recipient_button, locator_type='xpath')
        self.wait_for_loader_to_complete()
        self.webDriver.set_text(element=self.locators.recipients, locator_type='xpath', text=recipient_category)
        self.webDriver.get_web_element(element=self.locators.recipients, locator_type='xpath').send_keys(
            Keys.ARROW_DOWN)
        self.webDriver.get_web_element(element=self.locators.recipients, locator_type='xpath').send_keys(Keys.ENTER)
        self.verify_booking_unassigned_cabin_button()
        self.webDriver.click(element=self.locators.boarding_time, locator_type='id')
        search_response = self.webDriver.get_elements(element=self.locators.boarding_slots, locator_type="xpath")
        assert len(search_response) != 0, "No Boarding Slots Available"

    def verify_booking_unassigned_cabin_button(self):
        """
        To verify ‘_Bookings with Unassigned Cabins_' checkbox should be present in the ‘Select Cabins’ window
        :return:
        """
        self.webDriver.click(element=self.locators.select_cabin_button, locator_type='xpath')
        if not self.webDriver.is_element_display_on_screen(element=self.locators.unassigned_cabins, locator_type='xpath'):
            raise Exception('Bookings with Unassigned Cabins checkbox not be present')
        self.webDriver.click(element=self.locators.ok_button, locator_type='xpath')

    def verify_draft_ship(self, title):
        """
        To verify saved draft should not display on different ship
        :param title:
        :return:
        """
        self.webDriver.wait_for(2)
        ...
        self.webDriver.get_web_element(element=self.locators.template_search_bar, locator_type='xpath').send_keys(Keys.ENTER)
        self.webDriver.wait_for(3)
        if not self.webDriver.is_element_display_on_screen(element=self.locators.notification_list % title,
                                                           locator_type='xpath'):
            return True
        else:
            raise Exception('Saved draft displayed on different ship')

    def check_embark_date(self, scheduling):
        """
        To check whether draft section has any drafts or not
        """
        today = date.today()
        date_object = datetime.strptime(self.test_data['firstDay'], '%Y-%m-%d').date()
        if scheduling == 'selected voyage':
            if date_object <= today:
                return True
            else:
                return False
        else:
            my_date = date_object - timedelta(days=1)
            if my_date <= today:
                return True
            else:
                return False
