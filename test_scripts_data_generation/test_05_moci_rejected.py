    ...
    def test_09_approve_reject_guests(self, rest_shore, guest_data):
        ...
        for count, guest in enumerate(guest_data):
            ...
            for _count, _ in enumerate(_data['personalInfo']['photoDetail']):
                ...
                _data['personalInfo']['photoDetail'][_count]['rejectionReasons'] = [
                    {
                        "reasonId": "",
            ...
            for _count, _ in enumerate(_data['identificationInfo']['visas']):
                _data['identificationInfo']['visas'][_count]['status'] = "REJECTED"

            # Approve (always) Passport
            _data['identificationInfo']['passport']['status'] = "REJECTED"
            _data['identificationInfo']['passport']['rejectionReasons'] = [
                {
                    "reasonId": "",
                    "rejectionReasonId": "7004bc58-9f6b-11e7-827b-0a1a4261e962",
                    "isDeleted": False
                }
            ]
